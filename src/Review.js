  ...
  return (
    <List className={classes.list}>
          ...
          <ListItem className={classes.listItem} key={key}>
            <Typography variant="h4" className={classes.typography}>
              ...
              <span className={classes.span}>
                {shoppingbag[key].product.name}: ${shoppingbag[key].product.price} * {shoppingbag[key].counter} = <b>${shoppingbag[key].product.price * shoppingbag[key].counter}</b>
              </span>
            </Typography>
          </ListItem>
        ) : ('')
      ...
      <Typography className={classes.total} variant="h4">
        <b>Total:
          ${Object.keys(shoppingbag).reduce((total=0, key) => (
            total = total + (shoppingbag[key].product ? shoppingbag[key].product.price * shoppingbag[key].counter : 0)),
          0).toFixed(2)}
        </b>
      </Typography>
    </List>
